...
//Хранить все слова в одной таблице и добавить поле группы слов
...
export const {setUserVocabulary} = vocabularSlice.actions

const dictionarySlice = createSlice({
    name: 'dictionary',
    initialState: dictionary,
    reducers: {
        setDictionary: (state: any, action: any) => [...state, action.payload]
    }
})
